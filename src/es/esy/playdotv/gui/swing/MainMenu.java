...
public class MainMenu{
	...
	private void initialize() {
		...
		JMenuItem mntmPomoc = new JMenuItem("Informácie");
		mntmPomoc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Github: https://github.com/ShardBytes/library-book-scanner", "Informácie", JOptionPane.INFORMATION_MESSAGE, null);
			}
		});
